...
- replace Google Maps embeds with a MapLibre GL JS map. Using API calls to:
...
As a result, the response is an extension page that contains a [MapLibre GL JS](https://maplibre.org/maplibre-gl-js/docs/) + [OSM](https://www.openstreetmap.org/) + [ArgGIS](https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/) map.
